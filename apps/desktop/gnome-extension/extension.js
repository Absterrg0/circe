...
const NAME = "org.gnome.Shell.Extensions.CirceSnapShot";
const PATH = "/org/gnome/Shell/Extensions/CirceSnapShot";
...
export default class CirceSnapShotExtension extends Extension {
  enable() {
