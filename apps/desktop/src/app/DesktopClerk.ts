...
>()("@circe/desktop/app/DesktopClerk") {}
...
/** Exported for the SDK-wiring test; production callers use the layer. */
...
export const make = Effect.gen(function* () {
  ...
  // the lock would create "Circe" and make the legacy-install
