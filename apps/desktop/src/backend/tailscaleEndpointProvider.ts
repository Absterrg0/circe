import { createAdvertisedEndpoint } from "@circe/shared/advertisedEndpoint";
import type { AdvertisedEndpoint, AdvertisedEndpointProvider } from "@circe/contracts";
import {
...
export { parseTailscaleMagicDnsName } from "@circe/tailscale";
