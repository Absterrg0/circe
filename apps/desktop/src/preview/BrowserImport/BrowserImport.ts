 ...
 * into a Circe browser profile's Electron partition.
 *
...
import { BrowserImportFailureReason } from "@circe/contracts";
...
import { HostProcessExecutablePath, HostProcessPlatform } from "@circe/shared/hostProcess";
...
>()("@circe/desktop/preview/BrowserImport/BrowserImport") {}
