...
const PREVIEW_PARTITION_PREFIX = "persist:circe-preview-";
/**
 ...
 */
const PREVIEW_EPHEMERAL_PARTITION_PREFIX = "circe-preview-ephemeral-";
...
>()("@circe/desktop/preview/BrowserSession") {}
