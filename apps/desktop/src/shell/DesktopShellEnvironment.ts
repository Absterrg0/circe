...
>()("@circe/desktop/shell/DesktopShellEnvironment") {}
...
const startMarker = (name: string) => `__CIRCE_ENV_${name}_START__`;
const endMarker = (name: string) => `__CIRCE_ENV_${name}_END__`;
