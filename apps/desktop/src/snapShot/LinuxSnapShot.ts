...
const EXTENSION = "org.gnome.Shell.Extensions.CirceSnapShot";
const EXTENSION_PATH = "/org/gnome/Shell/Extensions/CirceSnapShot";
...
export class LinuxCaptureConnection {
  ...
  async captureExtension(appId: string, options?: FeedbackOptions): Promise<LinuxWindowSnapshot> {
    ...
    if (result !== RequestNameReply.PRIMARY_OWNER) {
      throw new Error("Another Circe instance is capturing a window. Try again.");
    }
