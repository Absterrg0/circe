import type { DesktopSshPasswordPromptRequest } from "@circe/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@circe/contracts";
import type { SshPasswordRequest } from "@circe/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedError<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `The desktop app window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@circe/desktop/ssh/DesktopSshPasswordPrompts") {}
