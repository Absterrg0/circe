...
public final class CirceComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate, UIGestureRecognizerDelegate {
  ...
  private var fontFamily = "Inter-Regular"
