...
#import "CirceMarkdownTextRunComponentDescriptor.h"
...
@interface CirceMarkdownTextRun () <RCTCirceMarkdownTextRunViewProtocol>

@end

@implementation CirceMarkdownTextRun {
  NSString * _text;
...
{
    return concreteComponentDescriptorProvider<CirceMarkdownTextRunComponentDescriptor>();
}

- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    static const auto defaultProps = std::make_shared<const CirceMarkdownTextRunProps>();
    _props = defaultProps;
  }
  return self;
}
...
{
  const auto &oldViewProps = *std::static_pointer_cast<CirceMarkdownTextRunProps const>(_props);
  const auto &newViewProps = *std::static_pointer_cast<CirceMarkdownTextRunProps const>(props);
...
- (nullable UIMenu *)contextMenu
{
  ...
  __weak CirceMarkdownTextRun *weakSelf = self;
...
- (void)onContextMenuAction:(NSString *)actionIdentifier
{
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::CirceMarkdownTextRunEventEmitter>(_eventEmitter)
    ->onContextMenuAction(facebook::react::CirceMarkdownTextRunEventEmitter::OnContextMenuAction{
...
- (void)onPress {
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::CirceMarkdownTextRunEventEmitter>(_eventEmitter)
    ->onPress(facebook::react::CirceMarkdownTextRunEventEmitter::OnPress{});
  }
}
...
- (void)onLongPress {
  if (_eventEmitter != nullptr) {
    std::dynamic_pointer_cast<const facebook::react::CirceMarkdownTextRunEventEmitter>(_eventEmitter)
    ->onLongPress(facebook::react::CirceMarkdownTextRunEventEmitter::OnLongPress{});
  }
}
...
Class<RCTComponentViewProtocol> CirceMarkdownTextRunCls(void)
{
    return CirceMarkdownTextRun.class;
}
