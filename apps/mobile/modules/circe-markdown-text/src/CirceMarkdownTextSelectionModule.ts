...
interface CirceMarkdownTextSelectionNativeModule {
...
const nativeModule = requireOptionalNativeModule<CirceMarkdownTextSelectionNativeModule>(
  "CirceMarkdownTextSelection",
);
