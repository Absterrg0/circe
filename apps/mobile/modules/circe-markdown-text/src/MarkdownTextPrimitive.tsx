...
import { setMarkdownSelectionHandleColor } from "./CirceMarkdownTextSelectionModule";
import CirceMarkdownTextRunNativeComponent from "./CirceMarkdownTextRunNativeComponent";
import CirceMarkdownTextNativeComponent from "./CirceMarkdownTextNativeComponent";
...
function MarkdownTextPrimitiveChild({
  ...
  const nativeChildren = React.Children.toArray(children).map((child) => {
    ...
    return (
      ...
      <CirceMarkdownTextRunNativeComponent
  ...
  if (!isAncestor) {
    ...
    return (
      <TextAncestorContext.Provider value={contextValue}>
        <CirceMarkdownTextNativeComponent
          {...textDefaults}
          {...containerProps}
          style={[flattenedStyle]}
        >
