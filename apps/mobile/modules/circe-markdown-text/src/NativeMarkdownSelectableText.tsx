...
import { decodeComposerContextFragment } from "@circe/shared/composerContextClipboard";
import {
  findNodeHandle,
  Image,
  Linking,
...
} from "./CirceMarkdownTextSelectionModule";
...
export function NativeMarkdownSelectableText(props: {
  ...
  // CirceMarkdownText only rebuilds its attributed string during native layout. A
