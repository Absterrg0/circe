package expo.modules.circenativecontrols
...
class CirceKeyboardCommandsModule : Module() {
  override fun definition() = ModuleDefinition {
    Name("CirceKeyboardCommands")

    View(CirceKeyboardCommandsView::class) {
      Prop("enabledCommands") { view: CirceKeyboardCommandsView, commands: List<String> ->
...
class CirceKeyboardCommandsView(
  context: Context,
