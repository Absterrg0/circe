...
public final class CirceKeyboardCommandsModule: Module {
  public func definition() -> ModuleDefinition {
    Name("CirceKeyboardCommands")

    View(CirceKeyboardCommandsView.self) {
      Prop("enabledCommands") { (view: CirceKeyboardCommandsView, commands: [String]) in
...
public final class CirceKeyboardCommandsView: ExpoView {
