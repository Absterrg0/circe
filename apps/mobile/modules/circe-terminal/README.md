...
custom-I/O and live-padding branch. `CirceTerminalView` owns a `libghostty` surface and uses that
callback I/O model:
...
`circe/custom-io-ordered-feed` branch when vendored, based on VVTerm's
