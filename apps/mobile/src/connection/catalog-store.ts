...
import { ConnectionTransientError } from "@circe/client/connection";
...
export const CONNECTION_CATALOG_KEY = "circe.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "circe.connections";
