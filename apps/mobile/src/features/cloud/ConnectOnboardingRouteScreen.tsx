...
import { reportAtomCommandResult, settlePromise } from "@circe/client/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for Circe Mesh. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's Circe Mesh environments right after sign-in so every
