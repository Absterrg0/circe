...
const BUNDLE =
  "/Users/expo/workingdir/build/apps/mobile/ios/build/Build/Intermediates.noindex/ArchiveIntermediates/Circe/BuildProductsPath/Release-iphoneos/main.jsbundle";
const FATAL = {
...
describe("formatStartupCrashReport", () => {
  it("writes the app version and each crash's full detail", () => {
    ...
    expect(report.startsWith("Circe 1.1.1 (56)\n")).toBe(true);
