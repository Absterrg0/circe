import { type KnownTerminalSession } from "@circe/client/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@circe/contracts";
...
} from "@circe/shared/terminalLabels";
