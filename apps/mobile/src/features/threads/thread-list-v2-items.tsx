...
import type { EnvironmentProject, EnvironmentThreadShell } from "@circe/client/state/shell";
import type { EnvironmentThreadSearchMatch } from "@circe/client/state/thread-search";
import type { EnvironmentMachineKind } from "@circe/contracts";
import { canSnooze, resolveSnoozePresets } from "@circe/client/state/thread-settled";
