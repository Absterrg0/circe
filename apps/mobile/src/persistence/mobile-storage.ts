...
const CONNECTIONS_KEY = "circe.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "circe.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "circe.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "circe.recent-thread-shortcuts";
...
>()("@circe/mobile/persistence/MobileStorage") {}
