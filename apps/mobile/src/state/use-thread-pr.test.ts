import { ProjectId, type ThreadPullRequestLink, type VcsStatusResult } from "@circe/contracts";
...
const pullRequest: NonNullable<VcsStatusResult["pr"]> = {
  ...
  url: "https://github.com/t3tools/circe/pull/3774",
  baseRef: "main",
...
describe("resolveThreadPrSource compatibility", () => {
  const legacyRef = {
    ...
    repository: "t3tools/t3code",
    number: 1,
    url: "https://github.com/t3tools/circe/pull/1",
  };
  const branchRef = { ...legacyRef, number: 2, url: "https://github.com/t3tools/circe/pull/2" };
