...
const emitXAiPromptCompleteThenHang =
  process.env.CIRCE_ACP_EMIT_XAI_PROMPT_COMPLETE_THEN_HANG === "1";
...
const emitGrokBackgroundTaskStarted =
  process.env.CIRCE_ACP_EMIT_GROK_BACKGROUND_TASK_STARTED === "1";
...
const runningCommandSeparateSession =
  process.env.CIRCE_ACP_RUNNING_COMMAND_SEPARATE_SESSION === "1";
const exitAfterRunningCommandLaunch =
  process.env.CIRCE_ACP_EXIT_AFTER_RUNNING_COMMAND_LAUNCH === "1";
