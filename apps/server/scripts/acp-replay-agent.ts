...
const encodedTranscript = process.env.CIRCE_ACP_REPLAY_TRANSCRIPT;
const statusPath = process.env.CIRCE_ACP_REPLAY_STATUS_PATH;
const replayWorkspace = process.env.CIRCE_ACP_REPLAY_WORKSPACE ?? process.cwd();
