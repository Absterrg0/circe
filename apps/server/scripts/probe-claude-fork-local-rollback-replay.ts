...
import { ProviderInstanceId, type ProviderReplayEntry } from "@circe/contracts";
...
const MODEL_SELECTION = {
  ...
  model: process.env.CIRCE_CLAUDE_REPLAY_MODEL ?? "claude-sonnet-4-6",
} as const;
const SOURCE_PROMPT =
...
const sessionId =
  process.env.CIRCE_CLAUDE_REPLAY_SESSION_ID ?? (await Effect.runPromise(randomUuidV4));
