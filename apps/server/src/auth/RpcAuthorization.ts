...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.desktopUseGetStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.desktopUseCapture]: AuthOrchestrationOperateScope,
  [WS_METHODS.desktopUseInput]: AuthOrchestrationOperateScope,
  [WS_METHODS.desktopUseListWindows]: AuthOrchestrationReadScope,
  [WS_METHODS.desktopUseSubscribeFrames]: AuthOrchestrationOperateScope,
