...
import { RelayOkResponse } from "@circe/contracts/relay";
    ...
    runCloudCommand(
      ...
      Effect.gen(function* () {
        ...
        if (background) {
          ...
          yield* Console.log(
            platform === "darwin"
              ? "\n✓ Background service ready\n\nARIS will stay reachable while you are logged in to this Mac."
              : "\n✓ Background service ready\n\nARIS will stay reachable after you log out.",
          );
          return;
        }
        const serveCommand = yield* resolveCliCommand("serve");
