...
declare const __CIRCE_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __CIRCE_BUILD_CHANNEL__ === "undefined" ? "dev" : __CIRCE_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "Circe (Dev)",
  nightly: "Circe (Nightly)",
  latest: "Circe",
...
<html lang="en">
  <head>
    ...
    <title>Circe Mesh authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Circe Mesh. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
