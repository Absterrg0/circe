 ...
 */
import { type RemoteOpenTarget } from "@circe/contracts";
import { HostProcessHostname } from "@circe/shared/hostProcess";
import * as NetService from "@circe/shared/Net";
import { readTailscaleStatus } from "@circe/tailscale";
...
>()("@absterrg0/circe/environment/RemoteOpenTargets") {}
