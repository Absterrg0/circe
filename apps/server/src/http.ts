...
import { isDevProxiedPath } from "@circe/shared/devProxy";
import { decodeOtlpTraceRecords } from "@circe/shared/observability";
...
export const makeBrowserApiCorsLayer = (
  ...
  Layer.unwrap(
    Effect.gen(function* () {
      ...
      //
      // CIRCE_DEV_ALLOWED_ORIGINS covers dev servers reached from a second
