import { ProviderInstanceId, ThreadId } from "@circe/contracts";
...
>()("@absterrg0/circe/mcp/McpSessionRegistry") {}
 ...
 * the only thing guarding the `circe` toolkits on a remote-reachable server.
 */
