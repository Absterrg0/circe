 ...
 */
import { CommandId, IsoDateTime, NonNegativeInt, ProjectId, ThreadId } from "@circe/contracts";
import {
...
>()(
  "@absterrg0/circe/persistence/Services/OrchestrationCommandReceipts/OrchestrationCommandReceiptRepository",
) {}
