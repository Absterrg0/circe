 ...
 */
import { ApprovalRequestId, IsoDateTime, ThreadId, TurnId } from "@circe/contracts";
import {
...
>()(
  "@absterrg0/circe/persistence/Services/ProjectionPendingApprovals/ProjectionPendingApprovalRepository",
) {}
