...
import { OrchestrationMessageRole } from "@circe/contracts/legacy-orchestration";
...
>()(
  "@absterrg0/circe/persistence/Services/ProjectionThreadMessages/ProjectionThreadMessageRepository",
) {}
