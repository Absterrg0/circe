 ...
 */
import { RuntimeMode, IsoDateTime, ProviderInstanceId, ThreadId, TurnId } from "@circe/contracts";
import { OrchestrationSessionStatus } from "@circe/contracts/legacy-orchestration";
...
>()(
  "@absterrg0/circe/persistence/Services/ProjectionThreadSessions/ProjectionThreadSessionRepository",
) {}
