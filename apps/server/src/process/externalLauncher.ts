...
// per-command cache lookups in @circe/shared/shell.
//
...
// command-resolution cache in @circe/shared/shell, so a backward wall-clock
...
>()("@absterrg0/circe/process/externalLauncher") {}
