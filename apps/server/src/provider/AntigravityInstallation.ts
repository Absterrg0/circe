...
import { ProviderDriverKind, type ProviderInstallState } from "@circe/contracts";
import {
  HostProcessArchitecture,
  HostProcessEnvironment,
  HostProcessPlatform,
} from "@circe/shared/hostProcess";
import { resolveNodeExecutable, nodeRuntimeUnavailableMessage } from "@circe/shared/nodeRuntime";
...
>()("@absterrg0/circe/provider/AntigravityInstallation") {
