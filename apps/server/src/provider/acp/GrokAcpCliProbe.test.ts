 ...
 * Enable with: CIRCE_GROK_ACP_PROBE=1 vp test run GrokAcpCliProbe
 * Set CIRCE_GROK_LIVE_TURN=1 to also send a small prompt to the real model.
 *
...
describe.runIf(process.env.CIRCE_GROK_ACP_PROBE === "1")("Grok ACP CLI probe", () => {
  ...
  it.effect.skipIf(process.env.CIRCE_GROK_LIVE_TURN !== "1")(
