    ...
    Effect.gen(function* () {
      ...
      const configLayer = ConfigProvider.layer(
        ConfigProvider.fromUnknown({
          CIRCE_TELEMETRY_ENABLED: true,
          CIRCE_POSTHOG_KEY: "phc_test_key",
          CIRCE_POSTHOG_HOST: "http://localhost",
          CIRCE_TELEMETRY_FLUSH_BATCH_SIZE: 20,
        }),
      );
