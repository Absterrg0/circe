...
import type { VcsDriverKind, VcsError, VcsRepositoryIdentity } from "@circe/contracts";
import { VcsUnsupportedOperationError } from "@circe/contracts";
...
>()("@absterrg0/circe/vcs/VcsDriverRegistry") {}
