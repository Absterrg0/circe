...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@circe/shared/path";
import { normalizeSearchQuery } from "@circe/shared/searchRanking";
...
>()("@absterrg0/circe/workspace/WorkspaceEntries") {}
