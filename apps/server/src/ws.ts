...
import { sameUsageLimitCommandCoverage, withUsageLimitsCommands } from "@circe/shared/usageLimits";
...
const makeWsRpcLayer = (
  ...
  ServerWsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      // Circe control/voice/task-desk RPC methods are contributed by the
      // handler extension and scoped by RpcAuthorization. They are looked up
      // here because the extension and its authorization resolver are part of
      // the Circe product composition, not V2 orchestration.
