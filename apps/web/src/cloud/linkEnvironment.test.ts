...
import { RelayWebClientId } from "@circe/contracts/relay";
...
import { type RpcSession } from "@circe/client/rpc";
import { EnvironmentRegistry } from "@circe/client/connection";
import { ManagedRelay } from "@circe/client/relay";
import { remoteHttpClientLayer } from "@circe/client/rpc";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_CIRCE_RELAY_URL", "https://relay.example.test");
