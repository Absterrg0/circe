...
import { readConnectAuthorizeRequest } from "@circe/shared/connectAuth";
...
const invalidLinkMessage = {
  ...
  description:
    "The link is missing its authorization request. Re-run `circe connect` in your terminal and open the freshly printed URL.",
} as const;
  ...
  return (
    <AuthSurfaceShell>
      <ConnectCliAuthMessage
        ...
        description={
          isSignedIn
            ? "Redirecting to authorize Circe Mesh for your CLI…"
            : "Sign in to continue authorizing Circe Mesh for your CLI."
        }
      />
      {isLoaded && !isSignedIn ? (
        <div className="mt-6">
