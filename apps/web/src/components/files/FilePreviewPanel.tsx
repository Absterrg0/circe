...
import { mediaFileReference } from "@circe/client/media-reference";
...
const FILE_EXPLORER_STORAGE_KEY = "circe.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "circe.renderMarkdown";
const RENDER_BROWSER_FILE_STORAGE_KEY = "circe.renderBrowserFile";
const RENDER_TABLE_STORAGE_KEY = "circe.renderTable";
