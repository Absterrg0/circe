import type { DiscoveredLocalServer, ScopedThreadRef } from "@circe/contracts";
import { mapAtomCommandResult, type AtomCommandResult } from "@circe/client/state/runtime";
