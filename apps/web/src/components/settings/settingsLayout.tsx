...
import { DEFAULT_SERVER_SETTINGS, type ServerSettings } from "@circe/contracts";
...
export function SettingsRow({
  ...
  return (
    <div
      ...
      className={cn(
        "@container/settings-row rounded-[var(--control-radius)] px-3 sm:px-4 aria-disabled:opacity-50 aria-disabled:[&_*]:text-muted-foreground",
