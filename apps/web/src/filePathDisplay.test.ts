...
describe("formatWorkspaceRelativePath", () => {
  it("formats absolute workspace paths from the workspace root", () => {
    expect(
      formatWorkspaceRelativePath(
        "C:/Users/mike/dev-stuff/circe/apps/web/src/session-logic.ts:501",
        "C:/Users/mike/dev-stuff/circe",
      ),
    ).toBe("circe/apps/web/src/session-logic.ts:501");
  });
  ...
  it("keeps paths already rooted at the workspace label stable", () => {
    expect(
      formatWorkspaceRelativePath(
        "circe/apps/web/src/session-logic.ts:501",
        "C:/Users/mike/dev-stuff/circe",
      ),
    ).toBe("circe/apps/web/src/session-logic.ts:501");
  });
  ...
  it("preserves columns when present", () => {
    expect(
      formatWorkspaceRelativePath(
        "/C:/Users/mike/dev-stuff/circe/apps/web/src/session-logic.ts:501:9",
        "C:/Users/mike/dev-stuff/circe",
      ),
    ).toBe("circe/apps/web/src/session-logic.ts:501:9");
  });
