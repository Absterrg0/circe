...
import { VIDEO_FILE_EXTENSIONS } from "@circe/shared/video";
...
const PIERRE_ICON_SPRITE_ID = "circe-pierre-file-icon-sprite";

const CIRCE_FILE_ICON_SPRITE = `
...
export const CIRCE_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: CIRCE_FILE_ICON_SPRITE,
  byFileName: {
...
const completeIconResolver = createFileTreeIconResolver(CIRCE_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${CIRCE_FILE_ICON_SPRITE}`;
