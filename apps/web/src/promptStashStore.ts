import { ComposerContextRecord, ForwardCompatibleArray } from "@circe/contracts";
...
export const PROMPT_STASH_STORAGE_KEY = "circe:prompt-stash:v2";
/**
 ...
 */
const LEGACY_PROMPT_STASH_STORAGE_KEY = "circe:prompt-stash:v1";
