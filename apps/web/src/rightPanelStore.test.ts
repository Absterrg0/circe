...
describe("rightPanelStore", () => {
  ...
  it("tracks one surface per pull request", () => {
    const first = { projectId: "project-a", repository: "Absterrg0/circe", number: 4909 };
    const second = { projectId: "project-a", repository: "Absterrg0/circe", number: 4910 };
    useRightPanelStore.getState().openPullRequest(refA, first);
    useRightPanelStore.getState().openPullRequest(refA, second);
    const url = "https://gitlab.example.com/Absterrg0/circe/-/merge_requests/4909";
