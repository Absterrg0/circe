...
import { parseScopedProjectKey, scopedProjectKey } from "@circe/client/environment";
import type { EnvironmentId, ProjectCloneSnapshot, ScopedProjectRef } from "@circe/contracts";
