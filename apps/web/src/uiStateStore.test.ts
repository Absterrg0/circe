...
describe("uiStateStore pure functions", () => {
  ...
  it("stores the sidebar project scope and resets it to all projects", () => {
    const scoped = setSidebarProjectScopeKey(makeUiState(), "github.com/Absterrg0/circe");

    expect(scoped.sidebarProjectScopeKey).toBe("github.com/Absterrg0/circe");
    expect(setSidebarProjectScopeKey(scoped, "github.com/Absterrg0/circe")).toBe(scoped);
...
describe("uiStateStore persistence", () => {
  ...
  it("restores the sidebar project scope across reloads", () => {
    persistState(makeUiState({ sidebarProjectScopeKey: "github.com/Absterrg0/circe" }));
