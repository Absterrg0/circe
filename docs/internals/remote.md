...
Tailscale, SSH, and Circe Mesh change how the client reaches that server; they do
...
[Circe Mesh trust boundary](./circe-mesh.md).
...
connect. This is possible because the desktop renderer is not served by the backend: the `circe://`
