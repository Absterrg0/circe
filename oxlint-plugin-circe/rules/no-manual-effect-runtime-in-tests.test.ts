...
const rule = createOxlintRuleHarness("circe/no-manual-effect-runtime-in-tests", {
  filename: "fixture.test.ts",
});

describe("circe/no-manual-effect-runtime-in-tests", () => {
  rule.valid(
...
const productionRule = createOxlintRuleHarness("circe/no-manual-effect-runtime-in-tests");
...
const legacyRule = createOxlintRuleHarness("circe/no-manual-effect-runtime-in-tests", {
  filename: "legacy.test.ts",
  ruleOptions: [{ maxOccurrences: 2 }],
});

describe("circe/no-manual-effect-runtime-in-tests with maxOccurrences", () => {
  legacyRule.valid(
