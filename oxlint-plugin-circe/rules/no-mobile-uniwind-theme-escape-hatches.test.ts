...
const guardedMobileFile = createOxlintRuleHarness("circe/no-mobile-uniwind-theme-escape-hatches", {
  filename: "apps/mobile/src/features/settings/NewThemeSurface.tsx",
});
const reviewedInteropFile = createOxlintRuleHarness(
  "circe/no-mobile-uniwind-theme-escape-hatches",
  {
...
describe("circe/no-mobile-uniwind-theme-escape-hatches", () => {
