...
export function buildCirceSemanticPrompt(
  ...
  return [...T3CODE_SEMANTIC_PROMPT_RULES, ...buildCirceSemanticPromptContext(input, prepared)].join(
    "\n",
  );
}
