...
import { RelayManagedEndpoint } from "@circe/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@circe/client/authorization/RemoteDpopAccessToken",
)({
...
>()("@circe/client/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
