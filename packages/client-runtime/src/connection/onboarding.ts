import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@circe/contracts";
import { resolveRemotePairingTarget } from "@circe/shared/remote";
...
>()("@circe/client/connection/onboarding/ConnectionOnboarding") {}
