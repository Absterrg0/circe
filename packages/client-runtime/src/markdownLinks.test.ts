...
describe("parseFileUrlHref", () => {
  it.each([
    ...
    [
      "file:///D:/Programme/circe/OpenInPicker.tsx#L69",
      "D:/Programme/circe/OpenInPicker.tsx",
      "#L69",
    ],
...
describe("parseMarkdownFileLink", () => {
  ...
  it.each([
    ...
    ["\\\\server\\share\\image.png", "\\\\server\\share\\image.png"],
    ["/D:/Programme/circe/OpenInPicker.tsx", "D:/Programme/circe/OpenInPicker.tsx"],
    ["</D:/Programme/circe/ChatMarkdown.tsx:1>", "D:/Programme/circe/ChatMarkdown.tsx"],
...
describe("workspaceRelativeFilePath", () => {
  it.each([
    ...
    ["/repo/project/src/main.ts", "/repo/project/", "src/main.ts"],
    ["C:\\Users\\mike\\circe\\apps\\web\\a.ts", "C:/Users/mike/circe", "apps/web/a.ts"],
    ["/C:/Users/mike/circe/apps/web/a.ts", "C:/Users/mike/circe", "apps/web/a.ts"],
    ...
    ["C:/USERS/mike/circe/main.ts", "c:/users/MIKE/circe", "main.ts"],
    ["/C:/USERS/mike/circe/main.ts", "/c:/users/MIKE/circe", "main.ts"],
