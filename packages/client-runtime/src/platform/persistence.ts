...
>()("@circe/client/platform/persistence/ConnectionTargetStore") {}
...
>()("@circe/client/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@circe/client/platform/persistence/EnvironmentCacheStore") {}
...
}>("@circe/client/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
