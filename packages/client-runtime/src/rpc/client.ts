import { ORCHESTRATION_V2_WS_METHODS, WS_METHODS } from "@circe/contracts";
...
}>("@circe/client/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@circe/client/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
