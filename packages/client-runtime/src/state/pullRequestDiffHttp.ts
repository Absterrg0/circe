...
export class PullRequestDiffCredentialRejectedError extends Schema.TaggedError<PullRequestDiffCredentialRejectedError>()(
  ...
  override get message(): string {
    return "This environment session is no longer valid (invalid_credential). Refresh the page or quit and reopen Circe.";
  }
}
...
>()("@circe/client/state/pullRequestDiffHttp/PullRequestDiffLoader") {}
