 ...
 * machine into a Circe browser profile.
 *
...
export const BrowserImportInput = Schema.Struct({
  ...
  /** Circe profile the cookies are written into. */
...
const BROWSER_IMPORT_UNAVAILABLE_COPY: Readonly<Record<BrowserImportUnavailableReason, string>> = {
  ...
  needsFullDiskAccess:
    "Give Circe Full Disk Access in System Settings → Privacy & Security, then retry.",
