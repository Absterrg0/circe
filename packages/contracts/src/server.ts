...
/**
 * A palette the environment's machine publishes for Circe to follow, read
 ...
 * over as a coherent Circe palette instead of a foreign one.
 */
...
export const ServerSelfUpdateInput = Schema.Struct({
  /** Exact npm version of the `circe` package to install (never a dist-tag, so
