...
import { T3ProjectFile, CIRCE_PROJECT_FILE_SCHEMA_URL } from "@circe/contracts";
 ...
 *
 * Served from the marketing site at {@link CIRCE_PROJECT_FILE_SCHEMA_URL} so
...
export function buildT3ProjectFileJsonSchema(): Record<string, unknown> {
  ...
  const jsonSchema: Record<string, unknown> = {
    ...
    $id: CIRCE_PROJECT_FILE_SCHEMA_URL,
    ...document.schema,
  };
