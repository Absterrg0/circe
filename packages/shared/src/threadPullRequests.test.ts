...
describe("threadPullRequestKeysEqual", () => {
  ...
  it("ignores host and repository case", () => {
    ...
    expect(
      threadPullRequestKeysEqual(
        { host: "github.com", repository: "Absterrg0/circe", number: 1 },
        { host: "gitlab.com", repository: "Absterrg0/circe", number: 1 },
      ),
    ).toBe(false);
  });
});
...
describe("resolveThreadCurrentPullRequest", () => {
  ...
  it("reports a stack when several links are open and puts the highest layer on top", () => {
    const stack = {
      ...
      id: "s1",
      number: 1,
      url: "https://github.com/Absterrg0/circe/stacks/1",
      base: "main",
      layers: [
...
describe("legacyLinkedPullRequestOf", () => {
  const identity = {
    ...
    locator: {
      ...
      remoteName: "origin",
      remoteUrl: "https://github.com/Absterrg0/circe.git",
    },
  };
  ...
  it.each([
    {
      ...
      url: "https://github.enterprise.test/Absterrg0/circe/pull/7",
    },
...
describe("threadPullRequestSearchTerms", () => {
  it("includes completed and unsynced links but excludes dismissed links", () => {
    ...
    expect(terms).toContain("Absterrg0/circe#12");
    expect(terms).toContain("https://github.com/Absterrg0/circe/pull/12");
...
it("searches the legacy projection when old environments decode to an empty links list", () => {
  const linkedPullRequest = {
    ...
    repository: "Absterrg0/circe",
    number: 12,
    url: "https://github.com/Absterrg0/circe/pull/12",
  };
