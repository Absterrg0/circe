...
it.layer(NodeServices.layer)("dev-runner", (it) => {
  ...
  describe("runDevRunnerWithInput", () => {
    ...
    // Base-dir precedence (--home-dir > worktree .t3 > ambient CIRCE_HOME)
    ...
    it.effect("ignores an ambient CIRCE_HOME when no home is resolved", () =>
      Effect.gen(function* () {
        const env = yield* createDevRunnerEnv({
          mode: "dev",
          baseEnv: { CIRCE_HOME: "/home/user/.t3" },
          serverOffset: 0,
          webOffset: 0,
          t3Home: undefined,
          browser: undefined,
    ...
    describe("t3 home precedence", () => {
      ...
      it.effect("prefers the worktree .t3 over an ambient CIRCE_HOME", () =>
        Effect.gen(function* () {
          const path = yield* Path.Path;
          const root = yield* makeWorktree;
          const home = yield* spawnedHome({
