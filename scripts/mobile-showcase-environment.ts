...
export const SHOWCASE_PROJECT_ID = "circe";
...
const SHOWCASE_TERMINAL_PROMPT =
  "\u001b[1;32m→\u001b[0m \u001b[1;36mcirce\u001b[0m \u001b[1;34mgit:(\u001b[1;31mfeat/remote-command-center\u001b[1;34m)\u001b[0m \u001b[1;33m✗\u001b[0m ";
...
export const SHOWCASE_TERMINAL_BUFFER = [
  ...
  "  \u001b[32m→\u001b[0m  \u001b[2mProject:\u001b[0m  \u001b[1mcirce\u001b[0m \u001b[2m— ~/Code/circe\u001b[0m",
  "",
...
const PROJECT_FAVICONS = {
  circe: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
...
export const SHOWCASE_PROJECTS = [
  {
    ...
    title: "Circe",
    directory: "circe",
    repositoryUrl: "https://github.com/Absterrg0/Circe.git",
    favicon: PROJECT_FAVICONS.circe,
  },
  {
    id: "react",
    title: "React",
...
async function seedT3CodeWorkspace(workspaceRoot: string): Promise<void> {
  ...
  await NodeFSP.writeFile(
    ...
    `${JSON.stringify({ name: "circe", private: true, scripts: { test: "vp test" } }, null, 2)}\n`,
  );
  await NodeFSP.writeFile(NodePath.join(workspaceRoot, "favicon.svg"), PROJECT_FAVICONS.circe);
  await NodeFSP.writeFile(
...
async function seedShowcaseWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the Circe mobile screenshot harness.\n`,
  );
  await initializeRepository({
