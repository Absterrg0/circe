  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Circe prerelease is available for nightly testers."
          : "A new Circe latest release is available.",
...
).pipe(Command.withDescription("Post a Circe release announcement to Discord."));
