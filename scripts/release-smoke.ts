...
const workspaceFiles = [
  ...
  "apps/mobile/modules/circe-markdown-text/package.json",
  "apps/mobile/modules/circe-review-diff/package.json",
  "apps/mobile/modules/circe-terminal/package.json",
  "apps/marketing/package.json",
  "infra/relay/package.json",
  "oxlint-plugin-circe/package.json",
  ...
  "packages/circe-client-runtime/package.json",
  "packages/circe-core/package.json",
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=Circe Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
